...
import { argv, listeners } from "process";
...
export const createPodcast = mutation({
   ...
   //This mutation is required to generate the url after uploauding the file to the storage.
   ...
   // this query will get the podcasts based on the voiceType of the podcast , which we are showing in the similar Podcasts section.
